 ...
 * on 2017-05-07 at 11:53:49 UTC 
 * Modify at your own risk.
 */

package com.jorda.jokesapp.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getJokeFromLibrary".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link GetJokeFromLibrary#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public GetJokeFromLibrary getJokeFromLibrary() throws java.io.IOException {
    GetJokeFromLibrary result = new GetJokeFromLibrary();
    initialize(result);
    return result;
  }

  public class GetJokeFromLibrary extends MyApiRequest<com.jorda.jokesapp.backend.myApi.model.MyBean> {
     ...
     * parameters, call the {@link GetJokeFromLibrary#execute()} method to invoke the remote
     * operation. <p> {@link GetJokeFromLibrary#initialize(com.google.api.client.googleapis.services.A
     * bstractGoogleClientRequest)} must be called to initialize this instance immediately after
     * invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected GetJokeFromLibrary() {
      super(MyApi.this, "GET", REST_PATH, null, com.jorda.jokesapp.backend.myApi.model.MyBean.class);
    }
    ...
    @Override
    public GetJokeFromLibrary setAlt(java.lang.String alt) {
      return (GetJokeFromLibrary) super.setAlt(alt);
    }

    @Override
    public GetJokeFromLibrary setFields(java.lang.String fields) {
      return (GetJokeFromLibrary) super.setFields(fields);
    }

    @Override
    public GetJokeFromLibrary setKey(java.lang.String key) {
      return (GetJokeFromLibrary) super.setKey(key);
    }

    @Override
    public GetJokeFromLibrary setOauthToken(java.lang.String oauthToken) {
      return (GetJokeFromLibrary) super.setOauthToken(oauthToken);
    }

    @Override
    public GetJokeFromLibrary setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetJokeFromLibrary) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetJokeFromLibrary setQuotaUser(java.lang.String quotaUser) {
      return (GetJokeFromLibrary) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetJokeFromLibrary setUserIp(java.lang.String userIp) {
      return (GetJokeFromLibrary) super.setUserIp(userIp);
    }

    @Override
    public GetJokeFromLibrary set(String parameterName, Object value) {
      return (GetJokeFromLibrary) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.jorda.jokesapp.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.jorda.jokesapp.backend.myApi.model.MyBean.class);
